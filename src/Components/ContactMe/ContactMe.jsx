...
const ContactMe = () => {
    return (
    <section id="ContactMe" className=' grid grid-cols-2 max-w-7xl mx-auto px-4 pt-30 pb-50 '>
            ...
            <form className="contact-form flex flex-col gap-10">
                ...
                <div className=' flex flex-col'>
                    ...
                    <textarea className="border-b-2 border-black outline-none px-2 py-0" id="message" name="message" rows="5" required />
                </div>
